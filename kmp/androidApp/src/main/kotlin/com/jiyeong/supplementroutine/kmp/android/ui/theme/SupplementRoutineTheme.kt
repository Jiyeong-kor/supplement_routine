...
private val LightColors: ColorScheme = lightColorScheme(
    ...
    surfaceContainer = Color(0x80FFFFFF),
    surfaceContainerHigh = Color(0x99FFFFFF),
    surfaceContainerHighest = Color(0x66FFE0E9),
    outline = Color(0xE6FFFFFF),
    outlineVariant = Color(0xB3FFFFFF),
...
private val DarkColors: ColorScheme = darkColorScheme(
    ...
    surface = Color(0x8022242A),
    onSurface = Color(0xFFF8F7F4),
    surfaceVariant = Color(0x662C2F36),
    onSurfaceVariant = Color(0xFFC9CDD6),
    surfaceContainerLow = Color(0x661C1E23),
    surfaceContainer = Color(0x8022242A),
    surfaceContainerHigh = Color(0x99282B31),
    surfaceContainerHighest = Color(0x663A2630),
