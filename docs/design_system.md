...
- 타이포그래피: Pretendard 정적 폰트 파일을 사용하며 400, 500, 600, 700 weight만 등록합니다. Material 3 텍스트 역할을 유지하고, 본문은 가볍게 읽히도록 두며 제목만 단계적으로 강조합니다.
...
| BottomSheet | 상단 24px radius, drag handle 사용 |
| Dialog | 16px 이상 radius, 명확한 CTA |
